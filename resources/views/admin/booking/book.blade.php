                    ...
                    <form action="{{ route('admin.room.book') }}" method="POST" class="booking-form" id="booking-form">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="any" min="0" class="form-control" name="paid_amount"
                                       placeholder="@lang('Paying Amount')">
                            </div>

                            <div class="form-group mb-0">
                                <button type="button" class="btn btn--primary h-45 w-100 btn-book confirmBookingBtn">@lang('Book Now')</button>
                            </div>
                        </div>
                    </form>
                </div>
